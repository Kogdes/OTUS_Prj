...
Функция СериализоватьВJSON(Данные) Экспорт
	...
	Попытка
		...
		СтруктураЗаписи.Вставить("customer", Данные.Контрагент.Наименование);
		СтруктураЗаписи.Вставить("number_sert", Данные.Сертификат.Код);
		СтруктураЗаписи.Вставить("name_sert", Данные.Сертификат.Наименование);
		СтруктураЗаписи.Вставить("nominal_sert", Данные.Сертификат.Номинал.Номинал);
		ЗаписьJSON = Новый ЗаписьJSON;
		ЗаписьJSON.УстановитьСтроку(Новый ПараметрыЗаписиJSON(ПереносСтрокJSON.Нет, ,Истина));
